...
public class Averages {
    ...
    public static void main(String[] args) {
        ...
        gradeProjectOne = scanner.nextDouble();
        System.out.println("Enter student's second project grade.");
        gradeProjectTwo = scanner.nextDouble();
