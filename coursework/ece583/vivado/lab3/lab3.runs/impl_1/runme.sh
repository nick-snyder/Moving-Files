...
HD_PWD='C:/Users/no_kn/Documents/unh/coursework/ece583/vivado/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_tb.tcl -notrace
