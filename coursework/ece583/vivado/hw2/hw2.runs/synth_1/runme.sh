...
HD_PWD='C:/Users/no_kn/Documents/unh/coursework/ece583/vivado/hw2/hw2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log behavioral_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source behavioral_tb.tcl
