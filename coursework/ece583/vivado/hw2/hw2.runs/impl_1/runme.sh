...
HD_PWD='C:/Users/no_kn/Documents/unh/coursework/ece583/vivado/hw2/hw2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log behavioral_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source behavioral_tb.tcl -notrace
