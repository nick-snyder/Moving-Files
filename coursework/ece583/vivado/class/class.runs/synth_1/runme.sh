...
HD_PWD='C:/Users/no_kn/Documents/unh/coursework/ece583/vivado/class/class.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AlwaysBlock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AlwaysBlock.tcl
