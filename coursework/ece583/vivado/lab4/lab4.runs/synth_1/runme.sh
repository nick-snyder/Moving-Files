...
HD_PWD='C:/Users/no_kn/Documents/unh/coursework/ece583/vivado/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log board_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source board_demo.tcl
