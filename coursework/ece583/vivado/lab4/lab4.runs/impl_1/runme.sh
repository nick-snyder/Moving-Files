...
HD_PWD='C:/Users/no_kn/Documents/unh/coursework/ece583/vivado/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log board_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source board_demo.tcl -notrace
