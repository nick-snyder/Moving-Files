...
public class Madlib {
     ...
     * lineTwo with the same command and seperating 
    ...
    public static void main(String[] args) {
        ...
        nounOne = scnr.nextLine();

        System.out.print("Enter a noun: ");
        nounTwo = scnr.nextLine();

        System.out.print("Enter an adjective: ");
        adjectieTwo = scnr.nextLine();

        // String concatenation
        lineOne = lineOne + adjectiveOne;
        lineTwo = nounOne + lineTwo;
        lineThree = nounTwo + lineThree + adjectieTwo;
